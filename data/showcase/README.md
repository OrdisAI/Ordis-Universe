...
- emergence
- AI-safety
pretty_name: "Ordis Causal Universe - Product Showcase"
size_categories:
- n<1K
---

# Ordis Causal Universe Dataset — Product Showcase
...
| S10 | `S10_raw_seed_20018_ncap226/` | **$1,500/seed** | Raw simulation seed | **Complete raw output of one currency-emergent civilization (seed=20018).** 14,891 events, tick-level aggregations, entity samples, signoff metrics. This is what the raw data looks like before any processing. DVS combo at step 99 → share explosion 0→120 in ONE tick → permanent cooperation lock-in (ratio_sg=4.17). |
...
@misc{liu2026ordis,
  ...
  url={https://huggingface.co/datasets/sugiken/Ordis-Causal-Universe}
}
```
